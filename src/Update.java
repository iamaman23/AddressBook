...
public class Update extends JFrame {
	...
	public Update() {
		...
		JLabel lblEnterContactDetails = new JLabel("Update Details");
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
				String query="update contact set id=?, email=?, mobile=?, phone=?, address=? where firstname=? and lastname=?";
				...
				try
				{
					...
					if(flag!=0)
					{
						JOptionPane.showMessageDialog(getParent(), "Contact updated successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
						reset();
					}
					else
					{
						JOptionPane.showMessageDialog(getParent(), "User Not Found", "ERROR", JOptionPane.ERROR_MESSAGE);
